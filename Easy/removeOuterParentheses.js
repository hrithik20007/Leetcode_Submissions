...
var removeOuterParentheses = function(s) {
    var i,r=0;									//r keeps track whether the parentheses is outermost or not.
    var res=[];									//Stores the answer list
    ...
    return res.join('')							//Joins the answer list to give a string
};
