...
class Solution(object):
    def simplifyPath(self, path):
        ...
        for i in p:
            if i=='' or i=='.':     #Ignoring '//' or '.' cases
                continue
            elif i=='..':           #This would indicate going back a directory and thus popping the last word/alphabt indicating the directory or file name
                if ans!=[]:         #'/..' would mean '/'
                    ans.pop()
            else:
                ans.append(i)
